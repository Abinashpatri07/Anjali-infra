...
//         isScrolled ? "bg-slate-900 text-white shadow-lg py-3" : "bg-transparent text-white py-4"
//       }`}
//     >
      ...
      >
        ...
        <div className="absolute bottom-8 left-0 right-0 px-6">
          <div className="border-t border-slate-700/50 pt-6">
            <h3 className="text-sm font-medium text-slate-400 mb-4 uppercase tracking-wider">Follow Us</h3>
