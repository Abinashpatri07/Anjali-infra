        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4 text-left md:text-center">
            ...
            <div className="flex flex-col space-y-2">
              <Link
                to="/"
                className="text-slate-200 hover:text-cyan-300 text-sm"
              >
                Home
              </Link>
              <Link
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center space-x-3">
              ...
              <a
                href="tel:+918099966699"
                className="text-slate-200 hover:text-cyan-300 transition-colors duration-200 text-sm"
              >
                +91 80999 66699
              </a>
            </div>
            ...
            <div className="flex items-center space-x-3">
              ...
              <a
                href="mailto:mishra.niranjan@anjaliinfra.in"
                target="_blank"
          ...
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex items-center space-x-6">
              ...
              <div className="flex space-x-4">
                <a
                  href="#"
                  className="text-slate-400 hover:text-cyan-300 transition-all duration-200 transform hover:scale-110"
                >
                  <Facebook size={18} />
                </a>
                <a
                ...
                <a
                  href="https://share.google/983vCpJKLLFNHtz9v"
                  className="text-slate-400 hover:text-cyan-300 transition-all duration-200 transform hover:scale-110"
                >
                  <Twitter size={18} />
                </a>
            ...
            <div className="text-slate-400 text-sm">
              Developed by{" "}
              <span className="text-cyan-300 font-medium">Abinash Patri</span>
            </div>
          </div>
        </div>
      </div>
