...
const Home: React.FC = () => {
  ...
  const c1 = '/images/project1.jpg';
  const c2 = '/images/project2.jpg';
  const c3 = '/images/project3.jpg';
  ...
  const services = [
    {
      ...
      colorTheme: {
        ...
        buttonGradient: "from-blue-600/20 to-cyan-600/20 hover:from-blue-600/30 hover:to-cyan-600/30",
      ...
      about: "Professional telecom tower erection services with precision engineering and safety compliance. We handle complete installation from foundation to commissioning, ensuring reliable communication infrastructure that meets industry standards and regulatory requirements.",
      features: [
    ...
    },
    {
      ...
      colorTheme: {
        ...
        buttonGradient: "from-yellow-600/20 to-orange-600/20 hover:from-yellow-600/30 hover:to-orange-600/30",
      ...
      about: "Comprehensive electrical substation maintenance and operational services ensuring reliable power distribution with maximum uptime and safety standards. Our expert team provides 24/7 monitoring, preventive maintenance, and emergency response services.",
      features: [
    ...
    },
    {
      ...
      colorTheme: {
        ...
        buttonGradient: "from-green-600/20 to-emerald-600/20 hover:from-green-600/30 hover:to-emerald-600/30",
      ...
      about: "Complete road construction and infrastructure development services from planning to execution, delivering durable and sustainable transportation networks. We specialize in highways, urban roads, and complete infrastructure solutions.",
      features: [
      ...
      >
        ...
        {activePopup && (
          <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4" onClick={closePopup}>
            <div className="bg-slate-900 rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto border border-white/20 shadow-2xl" onClick={(e) => e.stopPropagation()}>
                  ...
                  <div key={service.id} className="p-8">
                    ...
                    <div className="flex items-center justify-between mb-6">
                      <div className="flex items-center space-x-4">
                        <div className={`w-12 h-12 bg-gradient-to-br ${service.colorTheme.gradient} rounded-xl flex items-center justify-center`}>
                          {service.icon}
                        </div>
                        <div>
                          <h3 className="text-2xl font-bold text-white">{service.title}</h3>
                          <p className={`${service.colorTheme.textColor} text-sm font-semibold uppercase tracking-wider`}>
                            {service.subtitle}
                          </p>
                        </div>
                      </div>
                    ...
                    {/* About Section */}
                    <div className="mb-8">
                      <h4 className={`text-lg font-semibold ${service.colorTheme.textColor} mb-4`}>About This Service</h4>
                    ...
                    {/* Features Section */}
                    <div className="mb-8">
                      <h4 className={`text-lg font-semibold ${service.colorTheme.textColor} mb-4`}>Key Features & Services</h4>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                        {service.features.map((feature, index) => (
                          <div key={index} className="flex items-center space-x-3 p-3 bg-white/5 rounded-lg border border-white/10">
                            <span className={`w-2 h-2 ${service.colorTheme.featureColor} rounded-full flex-shrink-0`}></span>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4">
                      <button className={`flex-1 bg-gradient-to-r ${service.colorTheme.popupGradient} hover:shadow-lg text-white px-6 py-3 rounded-lg font-medium transition-all duration-300 transform hover:scale-105`}>
                        Request Quote
                      </button>
        ...
        <div className="container mx-auto px-5 max-w-7xl relative z-10">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-gray-300 text-lg max-w-3xl mx-auto leading-relaxed">
              We specialize in delivering comprehensive infrastructure solutions across multiple domains, 
          ...
          {/* <div className="text-center mt-16">
            ...
            <button className="bg-gradient-to-r from-blue-500 to-cyan-500 hover:from-blue-600 hover:to-cyan-600 text-white px-10 py-4 rounded-lg font-medium transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105 text-lg">
              Get A Quote Today
            </button>
          </div> */}
        </div>
