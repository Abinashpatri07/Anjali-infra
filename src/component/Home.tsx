...
const Home: React.FC = () => {
  ...
  // const slides = [
  //   { src: "https://images.unsplash.com/photo-1541888946425-d81bb19240f5?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80", alt: "Infrastructure Project 1" },
  //   { src: "https://images.unsplash.com/photo-1558618047-3c8c76ca7d13?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80", alt: "Infrastructure Project 2" },
  //   { src: "https://images.unsplash.com/photo-1518709268805-4e9042af2176?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80", alt: "Infrastructure Project 3" },
  // ];
        ...
        <div className="container mx-auto px-5 py-20 max-w-7xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-1 lg:order-1">
              <div className="relative bg-white shadow-xl rounded-2xl p-6 border border-gray-200">
            ...
            <div className="order-2 lg:order-2 text-gray-800">
              <div className="space-y-6">
                ...
                <div className="bg-white rounded-xl p-6 border border-gray-200 shadow-lg">
                  ...
                  <p className="text-gray-800 text-lg font-medium">
                    <span className="text-cyan-600">Abinash Patri</span>
                  </p>
                  <p className="text-gray-600 text-sm mt-1">Founder & Owner</p>
