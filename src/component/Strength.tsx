...
//             <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold bg-gradient-to-r from-slate-800 via-blue-600 to-purple-600 bg-clip-text text-transparent mb-8">
//               ABOUT ANJALI INFRA
//             </h1>
...
const Strength: React.FC = () => {
  ...
  return (
    <section className="pt-28 lg:pt-32 pb-16 bg-gradient-to-br from-slate-50 via-white to-blue-50 min-h-screen relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* About Anjali Infra Section */}
        <div className="text-center mb-16">
          <div className="inline-block mb-8">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12 border border-slate-100 mb-16">
            <div className="max-w-4xl mx-auto">
              <p className="text-lg md:text-xl text-slate-700 leading-relaxed mb-6">
                Anjali Infra stands as a pioneering force in the infrastructure
                development sector, committed to delivering excellence through
                innovative engineering solutions and sustainable construction
                practices.
              </p>
              <p className="text-lg md:text-xl text-slate-700 leading-relaxed mb-6">
                Our company specializes in comprehensive infrastructure
                projects, ranging from electrical installations and civil
                engineering to complex industrial constructions, ensuring
                quality and reliability in every endeavor.
              </p>
              <p className="text-lg md:text-xl text-slate-700 leading-relaxed mb-6">
                At Anjali Infra, we believe in building not just structures, but
                lasting relationships with our clients, ensuring continued
                success and mutual growth in all our partnerships.
              </p>
              <p className="text-lg md:text-xl text-slate-700 leading-relaxed">
                Our commitment to innovation, quality craftsmanship, and timely
                project delivery makes us the preferred choice for infrastructure
                development across diverse sectors and regions.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-slate-600 mt-6 max-w-2xl mx-auto">
            Meet the dedicated professionals who drive our success through
            expertise, innovation, and leadership excellence.
          </p>
        </div>
          ...
          {managementTeam.map((member, index) => {
            ...
            return (
              ...
              >
                ...
                <div className="relative p-8">
                  <div
                    className={`inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br ${member.color} rounded-2xl shadow-lg mb-6 group-hover:scale-110 transition-all duration-500`}
                  >
                    <IconComponent className="text-2xl text-white" />
                  </div>
            ...
            {registrations.map((reg, index) => {
              ...
              return (
                ...
                >
                  <div className="p-6 text-center">
                    <div
                      className={`inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br ${reg.color} rounded-2xl shadow-lg mb-4`}
                    >
                      <IconComponent className="text-2xl text-white" />
                    </div>
                    <h4 className="text-lg font-bold text-slate-800 mb-3">
      ...
      {selectedImage && (
        ...
        >
          <div
            className="relative bg-white rounded-2xl p-6 max-w-2xl max-h-[90vh] overflow-hidden"
